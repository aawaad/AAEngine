...
set FLAGS=-Oi -EHsc -WX -W4 -wd4201 -wd4189 -wd4100 -wd4127 -wd4189 -wd4505 -wd4706 -wd4996 -FC -Z7 -nologo
set LINKER_FLAGS=/opt:ref /subsystem:windows
set LIBS=glew32s.lib opengl32.lib glu32.lib gdi32.lib dsound.lib kernel32.lib user32.lib
